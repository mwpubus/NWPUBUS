	...
	<div class="row clearfix">
		<div class="col-md-12 column">
				...
				<div class="row clearfix">
					<div class="col-md-12 column">
						<div class="row clearfix">
							<div class="col-md-4 column">
								<div class="btn-group">
									<a href="Student.jsp" class="buttonXK buttonXK2">长安--友谊</a>
									<a href="StudentY-C.jsp" class="buttonXK buttonXK2">友谊--长安</a>
								</div>
							</div>
							<div class="col-md-4 column">
								<br>								
			...
			<div class="tabbable" id="tabs-207109">
				...
				String sql = "select license,time,remain from tbus where (day=?) and (start='友谊') and (delay='正常工作'or delay='加班') and time>?order by time ";
									...
									<table class="table table-hover table-striped">
										...
										<tbody>
        									...
        									<tr>
            									...
            									<td>
								<!-- 这是一个模态框 ，用来确认操作 -->
								<button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#myModa1" disabled="disabled">预约</button><!-- 模态框（Modal） -->
  									...
  									<div class="modal-dialog">
      									<div class="modal-content">
											...
											<p>发车时间：<input  type="" class="text1" id="ltime" 
         									...
         									<p>路&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp线：<input  type="text" id="lplace" name = "lplace" class="text1" readonly="true" value="友谊校区--长安校区"></input> </p>
											</div>
				...
				String sql1 = "select license,time,remain from tobus where (day=?) and (start='友谊') and (delay='正常工作'or delay='加班')order by time ";
				...
				String sql2 = "select license,time,remain from dwork where (day=?) and (start='友谊') and (delay='正常工作'or delay='加班')order by time ";
    							...
    							else
    							{
    								status2="可预约";
        											 ...
        											 <tr>
            											...
            											<td>
						<!-- 这是一个模态框 ，用来确认操作 -->
							<button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#myModa3" disabled="disabled">预约</button><!-- 模态框（Modal） -->
				...
				String sql3 = "select license,time,remain from dwork where (day=?) and (start='友谊') and (delay='正常工作'or delay='加班')order by time ";
    							...
    							else
    							{
    								status3="可预约";
        											 ...
        											 <tr>
            											...
            											<td>
						<!-- 这是一个模态框 ，用来确认操作 -->
							<button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#myModa4" disabled="disabled">预约</button><!-- 模态框（Modal） -->
				...
				String sql4 = "select license,time,remain from dwork where (day=?) and (start='友谊') and (delay='正常工作'or delay='加班')order by time ";
         					 ...
         					 while (rs4.next()) {
    							...
    							else
    							{
    								status4="可预约";
            										...
            										<td>
						<!-- 这是一个模态框 ，用来确认操作 -->
							<button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#myModa5" disabled="disabled">预约</button><!-- 模态框（Modal） -->
				...
				String sql5 = "select license,time,remain from dwork where (day=?) and (start='友谊') and (delay='正常工作'or delay='加班')order by time ";
    							...
    							else
    							{
    								status5="可预约";
        											 ...
        											 <tr>
            											...
            											<td>
						<!-- 这是一个模态框 ，用来确认操作 -->
							<button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#myModa6" disabled="disabled">预约</button><!-- 模态框（Modal） -->
				...
				String sql6 = "select license,time,remain from dwork where (day=?) and (start='友谊') and (delay='正常工作'or delay='加班')order by time ";
    							...
    							else
    							{
    								status6="可预约";
        											 ...
        											 <tr>
            											...
            											<td>
						<!-- 这是一个模态框 ，用来确认操作 -->
							<button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#myModa7" disabled="disabled">预约</button><!-- 模态框（Modal） -->
  ...
  <div id="wrap" class="my-map">
	...
	!function(){
		var infoWindow, map, level = 18,
			center = {lng: 108.914572, lat: 34.243676},
			features = [{type: "Marker", name: "校车点", desc: "", color: "yellow", icon: "flg", offset: {x: -12, y: -26}, lnglat: {lng: 108.914572, lat: 34.243676}}];
