	...
	<div class="row clearfix">
		<div class="col-md-12 column">
			...
			<div class="tabbable" id="tabs-207109">
				...
				String sql = "select license,time,remain from tbus where (day=?) and (start='友谊') and (delay='正常工作')order by time ";
				...
				String sql1 = "select license,time,remain from tobus where (day=?) and (start='友谊') and (delay='正常工作')order by time ";
				...
				String sql2 = "select license,time,remain from dwork where (day=?) and (start='友谊') and (delay='正常工作')order by time ";
				...
				String sql3 = "select license,time,remain from dwork where (day=?) and (start='友谊') and (delay='正常工作')order by time ";
				...
				String sql4 = "select license,time,remain from dwork where (day=?) and (start='友谊') and (delay='正常工作')order by time ";
				...
				String sql5 = "select license,time,remain from dwork where (day=?) and (start='友谊') and (delay='正常工作')order by time ";
				...
				String sql6 = "select license,time,remain from dwork where (day=?) and (start='友谊') and (delay='正常工作')order by time ";
