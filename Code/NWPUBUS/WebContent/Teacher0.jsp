											...
											<table class="table table-hover table-striped">
												...
												<c:forEach items="" var="npubus" varStatus="nb">
													...
													<tr class="success">
														...
														<td>
						<!-- 这是一个模态框 ，用来确认操作 -->
							<button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#myModa">预约</button><!-- 模态框（Modal） -->
				...
				<div class="modal fade" id="myModa" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  									 <div class="modal-dialog">
      									<div class="modal-content">
         									...
         									<p>发车时间：<input  type="text" id="ltime" readonly="true" value="" class="text1"></input> </p>
         									<p>预约人数：<input  type="text" id="ltime" readonly="true" value="" class="text1"></input> </p>
         									<p>路&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp线：<input class="text1" type="text" id="ltime" class="text1" readonly="true" value="长安校区--友谊校区"></input> </p>      
         									 </div>
